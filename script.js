...
function render(rows){
  ...
  const now=new Date();
  set('updateDate',updateStamp); set('liveUpdateDate',updateStamp); set('startDate',`01.${String(now.getMonth()+1).padStart(2,'0')}.${now.getFullYear()} 00:00:00`);
...
const historicalMonths={
  ...
  3:{name:'апрель',where:'апреле',start:'01.04.2026 · 00:02:34',updated:'01.05.2026 · 00:58:22',plus:643952,total:7685677,
  ...
  4:{name:'май',where:'мае',start:'01.05.2026 · 00:58:22',updated:'01.06.2026 · 00:02:27',plus:692429,total:8109683,
  ...
  5:{name:'июнь',where:'июне',start:'01.06.2026 · 00:02:27',updated:'01.07.2026 · 00:00:00',plus:506536,total:8676767,
  ...
  6:{name:'июль',where:'июле',start:'01.07.2026 · 00:00:00',updated:'01.08.2026 · 00:00:46',plus:449446,total:8978400,
    topClubs:[['VooPooFamily #8',84521],['VooPooFamily #1',63893],['VooPooFamily #5',55725]],antiClub:['VooPooFamily #3',17767],members:[['VooPooFamily #6',24],['VooPooFamily #10',18],['VooPooFamily #8',17],['VooPooFamily #2',15],['VooPooFamily #1',14],['VooPooFamily #5',13],['VooPooFamily #9',10],['VooPooFamily #4',9],['VooPooFamily #7',9],['VooPooFamily #3',6]],
    effective:[['VooPooFamily #8','84 521 / 4 972 ⚡'],['VooPooFamily #1','63 893 / 4 564 ⚡'],['VooPooFamily #5','55 725 / 4 287 ⚡'],['VooPooFamily #9','36 564 / 3 656 ⚡'],['VooPooFamily #7','28 899 / 3 211 ⚡'],['VooPooFamily #3','17 767 / 2 961 ⚡'],['VooPooFamily #4','24 835 / 2 759 ⚡'],['VooPooFamily #10','35 865 / 1 993 ⚡'],['VooPooFamily #6','44 656 / 1 861 ⚡'],['VooPooFamily #2','20 681 / 1 379 ⚡']],
    pushers:[['VPF|ごめんね少年🕊️🥀',15834],['VPF | Playtop_0',13878],['VPF|mrzebro4ka',13795]],antiPusher:['VPF|$-winner-$',10],x3:[['VPF|ごめんね少年🕊️🥀',1523],['VPF|ᴛʀɪᴢᴇxxx💍',1049],['VPF|SLASH👾',1020]],anti3:['VPF | SOKOL',1],solo:[['VPF|DaʀκӃnight',416],['VPF|NiceColt⛩️',389],['VPF | Playtop_0',378]],shd:[['VPF|planet🌍',722],['VPF|mrzebro4ka',493],['VPF | Playtop_0',470]],wins:[['VPF|ごめんね少年🕊️🥀',1703],['VPF|ᴛʀɪᴢᴇxxx💍',1304],['VPF|NiceColt⛩️',1120]],antiWins:['VPF|RETS20',1],
    brawlers:[['VPF|Kurumi⛩️','BOLT',3010],['VPF|SwiZy','SIRIUS',2738],['VPF | samifer🐍','NORI',2723]],antiBrawler:['VPF|LinSu','GRIFF',1009],top10:[['VPF|ごめんね少年🕊️🥀',15834],['VPF | Playtop_0',13878],['VPF|mrzebro4ka',13795],['VPF|planet🌍',13639],['VPF|LINE💕',11892],['VPF | ZêRøX',11834],['VPF|NiceColt⛩️',11502],['VPF|DaʀκӃnight',11492],['VPF|LostPrime',10948],['VPF|ᴛʀɪᴢᴇxxx💍',10637]],
    clubPushers:[['#1','VPF|ᴛʀɪᴢᴇxxx💍',10637],['#2','VPF|Peetrix',6358],['#3','VPF|NiceColt⛩️',11502],['#4','VPF|DaʀκӃnight',11492],['#5','VPF | Playtop_0',13878],['#6','VPF|Голая Эмз',5501],['#7','VPF|$hark',9697],['#8','VPF|ごめんね少年🕊️🥀',15834],['#9','VPF|LINE💕',11892],['#10','VPF|LostPrime',10948]],tournament:[]},
  7:{name:'август',where:'августе',start:'01.08.2026 · 00:00:46',updated:'31.08.2026 · 21:00:05',plus:324893,total:7729331,
    topClubs:[['VooPooFamily #2',73070],['VooPooFamily #1',66609],['VooPooFamily #5',40525]],antiClub:['VooPooFamily #10',6571],
    members:[['VooPooFamily #6',22],['VooPooFamily #2',16],['VooPooFamily #1',14],['VooPooFamily #8',12],['VooPooFamily #5',10],['VooPooFamily #9',10],['VooPooFamily #10',7],['VooPooFamily #3',6],['VooPooFamily #7',6],['VooPooFamily #4',4]],
    effective:[['VooPooFamily #1','66 609 / 4 758 ⚡'],['VooPooFamily #2','73 070 / 4 567 ⚡'],['VooPooFamily #5','40 525 / 4 053 ⚡'],['VooPooFamily #7','15 552 / 2 592 ⚡'],['VooPooFamily #8','30 997 / 2 583 ⚡'],['VooPooFamily #9','24 944 / 2 494 ⚡'],['VooPooFamily #3','13 682 / 2 280 ⚡'],['VooPooFamily #4','8 676 / 2 169 ⚡'],['VooPooFamily #10','6 571 / 939 ⚡'],['VooPooFamily #6','18 178 / 826 ⚡']],
    pushers:[['VPF|Samurai',25729],['VPF| شكوليا',16032],['VPF|Peetrix',11642]],antiPusher:['VPF|frikopat',9],
    x3:[['VPF|SLASH👾',1597],['VPF|Peetrix',1526],['VPF | MikaS 夜',1399]],anti3:['VPF|Westic👅',1],
    solo:[['VPF|Samurai',716],['VPF| شكوليا',507],['VPF | Sava',235]],shd:[['VPF|Samurai',806],['VPF| شكوليا',522],['VPF|NiceColt⛩️',354]],
