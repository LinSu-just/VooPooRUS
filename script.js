...
const archiveMonths={
  2:{src:'assets/archive/march-v7.jpg?v=1',alt:'Итоги VooPooFamily за март'},
  3:{src:'assets/archive/april-v1.jpg?v=1',alt:'Итоги VooPooFamily за апрель'},
  4:{src:'assets/archive/may-v1.jpg?v=1',alt:'Итоги VooPooFamily за май'},
...
function openMonth(monthIndex,{historyUpdate=true}={}){
  ...
  if(monthIndex===new Date().getMonth()&&!archive&&!unavailable)loadData();
